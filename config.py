...
class Config(object):
    ...
    ADMIN = [int(admin) if id_pattern.search(admin) else admin for admin in os.environ.get('ADMIN', '5694158462').split()]

    # channels logs
    FORCE_SUB   = os.environ.get("FORCE_SUB", "TechifyBots") 
    LOG_CHANNEL = int(os.environ.get("LOG_CHANNEL", "-1002298463307"))
    BIN_CHANNEL = int(os.environ.get("BIN_CHANNEL", "-1002317605736"))
